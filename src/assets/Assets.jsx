...
export const Assets = () => {
  return (
    <nav aria-label="Main navigation" className="flex justify-between items-center px-6 py-4 shadow-md bg-white">
      
     <h2 className="text-xl font-bold text-orange-500 cursor-pointer">
  <a
  ...
  />
      ...
      <ul className="flex gap-6 items-center">
        <li className="cursor-pointer hover:text-orange-500 transition border-b-2 border-transparent hover:border-orange-500">
          Courses
        </li>
        <li className="cursor-pointer hover:text-orange-500 transition border-b-2 border-transparent hover:border-orange-500">
          Practice
